...
from K_mean import  executeK_means, InitCentroids
...
X = data['X']
distances, indexes = InitCentroids.findNearest(X, initial_centroids)
...
new_Centroids = InitCentroids.calibrate(X, indexes, numCentroids)
print(
    "values for new centroids should be = \n[[ 2.428301 3.157924 ]\n [ 5.813503 2.633656 ]\n [ 7.119387 3.616684 ]]\n")
print("new centroids values are")
print(new_Centroids)

# ==================== K-mean clustering ===================
print("Running K-mean Clustering ")
centroids, idx = executeK_means.startK_means(X, initial_centroids, 10, True)
...
values, idx = InitCentroids.findNearest(new_X, new_Centroids)
