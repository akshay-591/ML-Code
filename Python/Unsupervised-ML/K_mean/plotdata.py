...
def plot(X, index, numCentroids,centroids,previous_centroids):
    for i in range(numCentroids):
        ...
        b = mat.random.random()
        color = (r,g,b)
        pyplot.plot(previous_centroids[i, 0],previous_centroids[i, 1], color=color, linestyle='None', marker="+",
                    markersize=10, markeredgewidth=3)
        pyplot.plot(centroids[i, 0], centroids[i, 1], color=color, linestyle='None', marker="+",
                    markersize=10, markeredgewidth=3)
